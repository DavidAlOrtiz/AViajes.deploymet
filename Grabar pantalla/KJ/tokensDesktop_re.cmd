...
:Install_7
if not exist "%userprofile%\desktop\Tokens_Bak\Windows\tokens.dat" goto _end
...
cls
xcopy /cheriky "%userprofile%\desktop\Tokens_Bak\Windows" %Windir%\ServiceProfiles\NetworkService\AppData\Roaming\Microsoft\SoftwareLicensing  >nul
...
cls
xcopy /cheriky "%userprofile%\desktop\Tokens_Bak\Windows" %Windir%\ServiceProfiles\NetworkService\AppData\Roaming\Microsoft\SoftwareProtectionPlatform  >nul
taskkill /f /im wscript.exe >nul
start /i Successful.vbs
cscript //Nologo Successful_v.vbs
ping 127.0.0.1 -n 1 >nul
